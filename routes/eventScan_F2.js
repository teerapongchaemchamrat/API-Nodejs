...
const eventControll = require('../controllers/eventController_Scan_F2');
...
router.get('/chart',function(req,res){
    ...
    res.sendFile(path.resolve(__dirname,'D:/Application_API/index_F2.html'))
})

router.get('/report',function(req,res){
    res.header('Access-Control-Allow-Origin', '*');
    res.header('Access-Control-Allow-Headers', '*');
    res.sendFile(path.resolve(__dirname,'D:/Application_API/Report_ScanEm_F2.html'))
})
